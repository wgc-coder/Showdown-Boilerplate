...
let adWhitelist = (Config.adWhitelist ? Config.adWhitelist : ['evolution.psim.us']);
...
Config.chatfilter = function (message, user, room, connection) {
	...
	let pre_matches = (message.match(/psim|psim.us|psim us|psm.us|psm us|pornhub.com|Xvideos.com|redtube.com|https:\/\/pastebin.com\/GRvhXDFG|JAxq0kSF/g) || []).length;
